...
trainIdx <- createDataPartition(wle_train$classe,
                                p=0.66,
                                list=FALSE)
...
#
fom <- classe ~ num_window + roll_belt + 
...
# Check the result to determine accuracy (% of correct results):
#       correct prediction/number of testing records
#
chkresult <- testing$classe == result
sum(chkresult) / nrow(testing)

#  Generate the final model 
#  Write out the results to the required files
#
